...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/picture_viewer.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/picture_viewer ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/FileList.o: FileList.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileList.o FileList.cpp
...
${OBJECTDIR}/ImageFrame.o: ImageFrame.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImageFrame.o ImageFrame.cpp

${OBJECTDIR}/ImagePanel.o: ImagePanel.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImagePanel.o ImagePanel.cpp
